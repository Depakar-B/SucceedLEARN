<?php
/**
 * US Sexual Harassment Prevention Training — Contact.
 *
...
<section
	id="contact"
	class="sl-contact sl-contact--on-white sl-us-harassment-contact"
	aria-labelledby="sl-us-harassment-contact-title"
>
	<div class="container">
		<div class="sl-contact__grid">
			...
			<div class="sl-contact__content">
				...
				<h2 id="sl-us-harassment-contact-title">
					<?php esc_html_e( 'Give employees and supervisors the guidance', 'akaza-adventure' ); ?>
					<span><?php esc_html_e( 'their roles require', 'akaza-adventure' ); ?></span>
				</h2>

				<div class="sl-contact__copy">
					<p>
						<?php esc_html_e( 'Employees should know how to recognize concerns and use available reporting options. Supervisors should know how to receive, document and escalate concerns appropriately.', 'akaza-adventure' ); ?>
					</p>

					<p>
						<?php esc_html_e( 'Choose online U.S. sexual harassment prevention training based on location, role and applicable requirements.', 'akaza-adventure' ); ?>
					</p>
				</div>
