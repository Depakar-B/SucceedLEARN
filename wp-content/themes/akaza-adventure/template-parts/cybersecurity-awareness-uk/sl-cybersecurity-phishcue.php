    ...
    <div class="container">
        ...
        <div class="sl-cyber-awareness-phishcue__grid">
            ...
            <div class="sl-cyber-awareness-phishcue__content">
                ...
                <p class="sl-cyber-awareness-phishcue__availability">
                    <?php esc_html_e( 'Available only for Microsoft Office customers', 'akaza-adventure' ); ?>
                </p>
                ...
                <a
                    ...
                    href="#contact"
                >
                    <span><?php esc_html_e( 'Explore PhishCue in a Demo', 'akaza-adventure' ); ?></span>
