    ...
    <div class="container">
        ...
        <div class="sl-cybersecurity-campaign__heading">
            ...
            <p class="sl-cybersecurity-campaign__intro-text">
                <?php
                esc_html_e(
                    'Learning, testing and active email reporting, delivered as one coordinated Cyber Security Awareness Month campaign.',
                    'akaza-adventure'
                );
                ?>
            </p>
        ...
        <div class="sl-cybersecurity-campaign__row">
            ...
            <div class="sl-cybersecurity-campaign__content">
                ...
                <p>
                    <?php
                    esc_html_e(
                        'Equip employees to identify common cyber risks, verify unusual requests, protect business information and make safer decisions in their everyday work.',
                        'akaza-adventure'
                    );
                    ?>
                </p>
                ...
                <div class="sl-cybersecurity-campaign__checklist">
					...
					$training_topics = array(
						...
						__( 'AI-based Attacks', 'akaza-adventure' ),
        ...
        <div class="sl-cybersecurity-campaign__row sl-cybersecurity-campaign__row--reverse">
            ...
            <div class="sl-cybersecurity-campaign__content">
                ...
                <p>
                    <?php
                    esc_html_e(
                        'Test how employees respond to realistic but controlled phishing scenarios. Each simulation is approved in advance, delivered safely and measured without collecting genuine passwords.',
                        'akaza-adventure'
                    );
                    ?>
                </p>
