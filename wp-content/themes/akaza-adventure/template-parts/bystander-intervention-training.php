<?php
/**
 * Bystander Intervention Training page content.
 *
...
$course = function_exists( 'akaza_get_inclusive_course' ) ? akaza_get_inclusive_course( 'bystander' ) : null;
if ( ! $course ) {
	return;
}
?>
<main id="main-content" class="sl-iwc-page">
	...
	<?php get_template_part( 'template-parts/inclusive-course/related', null, array( 'course_id' => 'bystander' ) ); ?>
