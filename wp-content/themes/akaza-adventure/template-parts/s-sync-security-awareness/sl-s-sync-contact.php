...
<section class="sl-s-sync-contact" id="request-demo" aria-labelledby="sl-s-sync-contact-title">
	<div class="container">

		<div class="sl-s-sync-contact__grid">

			<div class="sl-s-sync-contact__content">

				<span class="sl-home-sub-heading">
					<?php esc_html_e( 'Talk to our team', 'akaza-adventure' ); ?>
				</span>

				<h2 id="sl-s-sync-contact-title">
					<?php esc_html_e( 'See S-Sync', 'akaza-adventure' ); ?>
					<span><?php esc_html_e( 'in action', 'akaza-adventure' ); ?></span>
				</h2>

				<div class="sl-s-sync-contact__copy">
					<p>
						<?php
						esc_html_e(
					...
					<p>
						<?php
						esc_html_e(
							'Tell us about your identity providers, HR systems, and current awareness programme. We will get back to you with the next steps for a tailored walkthrough.',
							'akaza-adventure'
						);
						?>
					</p>
				...
				<div class="sl-s-sync-contact__details">

					<a class="sl-s-sync-contact__email" href="mailto:info@succeedtech.com">
						<span class="sl-s-sync-contact__email-label">
							<?php esc_html_e( 'Email us', 'akaza-adventure' ); ?>
						</span>
						<span class="sl-s-sync-contact__email-value">
							info@succeedtech.com
						</span>
					</a>

					<a
						class="sl-s-sync-contact__whatsapp"
					...
					>
						<span class="sl-s-sync-contact__whatsapp-icon" aria-hidden="true">
						...
						<span class="sl-s-sync-contact__whatsapp-text">
							<span class="sl-s-sync-contact__whatsapp-label"><?php esc_html_e( 'WhatsApp us', 'akaza-adventure' ); ?></span>
						</span>
					</a>
			...
			<div class="sl-s-sync-contact__form">
				<div class="sl-s-sync-contact__form-inner sl-home-form-wrapper sl-home-form-wrapper--slim">
					<?php
