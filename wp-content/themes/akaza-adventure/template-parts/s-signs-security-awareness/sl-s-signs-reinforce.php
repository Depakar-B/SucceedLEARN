...
<section
	class="sl-s-signs-reinforce"
	aria-labelledby="sl-s-signs-reinforce-title"
>
	<div class="container">

		<div class="sl-s-signs-reinforce__grid">

			<div class="sl-s-signs-reinforce__media">
				<div class="sl-s-signs-reinforce__image-placeholder">
					<span><?php esc_html_e( 'Image Placeholder', 'akaza-adventure' ); ?></span>
				</div>
			</div>

			<div class="sl-s-signs-reinforce__content">

				<span class="sl-home-sub-heading">
					<?php esc_html_e( 'Everyday Security Habits', 'akaza-adventure' ); ?>
				</span>
