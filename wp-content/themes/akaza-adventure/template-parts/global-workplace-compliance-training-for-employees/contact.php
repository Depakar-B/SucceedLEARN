...
<section id="contact" class="sl-home-contact-section sl-gwct-contact-section" aria-labelledby="sl-gwct-contact-heading">
	...
	<div class="container">
		...
		<div class="row align-items-start gy-5 sl-gwct-contact__grid">
			...
			<div class="col-lg-6">
				...
				<div class="sl-home-contact-content sl-gwct-contact-content">
					...
					<h2 id="sl-gwct-contact-heading">
						<?php
						echo wp_kses(
							__( 'See how workplace compliance training works for <span>your organisation</span>', 'akaza-adventure' ),
							array( 'span' => array() )
						);
						?>
					</h2>
					...
					<div class="sl-gwct-contact-direct">
						...
						<div class="sl-gwct-contact-direct__grid">
							...
							<a href="mailto:info@succeedtech.com" class="sl-gwct-contact-direct__item">
							...
							>
								...
								<span class="sl-gwct-contact__whatsapp-text">
									<span class="sl-gwct-contact__whatsapp-label"><?php esc_html_e( 'WhatsApp us', 'akaza-adventure' ); ?></span>
			...
			<div class="col-lg-6">
				...
				<div class="sl-gwct-contact__form-wrap">
