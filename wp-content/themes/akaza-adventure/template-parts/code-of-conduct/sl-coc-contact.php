	...
	<div class="container">
		...
		<div class="sl-coc-contact__grid">
			...
			<div class="sl-coc-contact__content">
				...
				<div class="sl-coc-contact__details">
					<a class="sl-coc-contact__email" href="mailto:info@succeedtech.com">
						<span class="sl-coc-contact__email-label">
							<?php esc_html_e( 'Email us', 'akaza-adventure' ); ?>
						</span>
						<span class="sl-coc-contact__email-value">
							info@succeedtech.com
						</span>
					</a>

					<a
						class="sl-coc-contact__whatsapp"
						href="<?php echo esc_url( $whatsapp_url ); ?>"
						target="_blank"
						rel="noopener noreferrer"
						aria-label="<?php esc_attr_e( 'Chat on WhatsApp', 'akaza-adventure' ); ?>"
					>
						<span class="sl-coc-contact__whatsapp-icon" aria-hidden="true">
						...
						<span class="sl-coc-contact__whatsapp-text">
							<span class="sl-coc-contact__whatsapp-label">
