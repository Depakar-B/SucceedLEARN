	...
	<div class="container">
		...
		<div class="sl-sa-definition__layout">
			...
			<div class="sl-sa-definition__media">
				<div
					class="sl-sa-definition__image-placeholder"
					role="img"
					aria-label="<?php esc_attr_e( 'Security awareness definition image placeholder', 'akaza-adventure' ); ?>"
				>
					<span class="sl-sa-definition__image-size">
						<?php esc_html_e( 'Image: 640 × 720 px', 'akaza-adventure' ); ?>
					</span>

					<span class="sl-sa-definition__image-note">
						<?php esc_html_e( 'Security Awareness Definition Image', 'akaza-adventure' ); ?>
					</span>
				</div>
			</div>
