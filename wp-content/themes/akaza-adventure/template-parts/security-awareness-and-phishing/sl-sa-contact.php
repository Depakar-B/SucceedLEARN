<?php
/**
 * Security Awareness — Contact / Request a Demo CTA.
 *
...
?>
<section class="sl-sa-contact" id="contact" aria-labelledby="sl-sa-contact-title">
	<div class="container">
		<div class="sl-sa-contact__grid">

			<div class="sl-sa-contact__content">

				<div class="sl-sa-contact__heading">
					<span class="sl-home-sub-heading">
						<?php esc_html_e( 'Talk to our team', 'akaza-adventure' ); ?>
					</span>

					<h2 id="sl-sa-contact-title">
						<?php esc_html_e( 'See the Security Behaviour & Culture Suite', 'akaza-adventure' ); ?>
						<span><?php esc_html_e( 'in action', 'akaza-adventure' ); ?></span>
					</h2>

					<p class="sl-sa-contact__lead">
						<?php esc_html_e( 'Book a short, no-obligation demo and we will walk you through awareness training, phishing simulations, microlearning, analytics, and how the suite can fit your organisation.', 'akaza-adventure' ); ?>
					</p>
				</div>

				<div class="sl-sa-contact__body">
					<p>
						<?php esc_html_e( 'Tell us about your workforce, compliance priorities, and current awareness programme. We will get back to you with the next steps for a tailored walkthrough.', 'akaza-adventure' ); ?>
					</p>
				</div>

				<div class="sl-sa-contact__details">

					<a class="sl-sa-contact__email" href="mailto:info@succeedtech.com">
						<span class="sl-sa-contact__email-label">
							<?php esc_html_e( 'Email us', 'akaza-adventure' ); ?>
						</span>
						<span class="sl-sa-contact__email-value">
					...
					>
						...
						<span class="sl-sa-contact__whatsapp-text">
							<span class="sl-sa-contact__whatsapp-label"><?php esc_html_e( 'WhatsApp us', 'akaza-adventure' ); ?></span>
						</span>
					</a>
			...
			<div class="sl-sa-contact__form-wrap">
