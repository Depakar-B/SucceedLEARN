<?php
/**
 * PCI DSS — Contact / Request a Demo.
 *
...
<section class="sl-pci-contact" id="request-demo" aria-labelledby="sl-pci-contact-title">
	<div class="container">

		<div class="sl-pci-contact__grid">

			<div class="sl-pci-contact__content">

				<span class="sl-home-sub-heading">
					<?php esc_html_e( 'Talk to our team', 'akaza-adventure' ); ?>
				</span>

				<h2 id="sl-pci-contact-title">
					<?php esc_html_e( 'See the PCI DSS Training', 'akaza-adventure' ); ?>
					<span><?php esc_html_e( 'in action', 'akaza-adventure' ); ?></span>
				</h2>

				<div class="sl-pci-contact__copy">
					<p>
						<?php
						esc_html_e(
				...
				<div class="sl-pci-contact__details">

					<a class="sl-pci-contact__email" href="mailto:info@succeedtech.com">
						<span class="sl-pci-contact__email-label">
							<?php esc_html_e( 'Email us', 'akaza-adventure' ); ?>
						</span>
						<span class="sl-pci-contact__email-value">
							info@succeedtech.com
						</span>
					</a>

					<a
						class="sl-pci-contact__whatsapp"
					...
					>
						<span class="sl-pci-contact__whatsapp-icon" aria-hidden="true">
						...
						<span class="sl-pci-contact__whatsapp-text">
							<span class="sl-pci-contact__whatsapp-label"><?php esc_html_e( 'WhatsApp us', 'akaza-adventure' ); ?></span>
						</span>
					</a>
			...
			<div class="sl-pci-contact__form">
				<div class="sl-pci-contact__form-inner sl-home-form-wrapper sl-home-form-wrapper--slim">
					<?php
