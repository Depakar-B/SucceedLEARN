	...
	<div class="container">
		...
		<div class="sl-infosec-challenge__intro">
			...
			<h3 class="sl-panel-title sl-infosec-challenge__intro-criteria-lead">
				<?php esc_html_e( 'Your organisation achieves either of the following:', 'akaza-adventure' ); ?>
			</h3>
				...
				<div class="sl-infosec-challenge__card-header">
					...
					<div>
						...
						<h3 class="sl-infosec-challenge__card-title">
							<?php esc_html_e( 'Your organisation demonstrates strong resilience.', 'akaza-adventure' ); ?>
						</h3>
					</div>
