				...
				<div class="sl-infosec-2026-how-it-works__steps">
					...
					<article class="sl-infosec-2026-how-it-works__step">
						...
						<div class="sl-infosec-2026-how-it-works__content">
							<h3 class="sl-panel-title">
								<?php esc_html_e( 'Enrol Your Workforce', 'akaza-adventure' ); ?>
							</h3>
							<p>
					...
					<article class="sl-infosec-2026-how-it-works__step">
						...
						<div class="sl-infosec-2026-how-it-works__content">
							...
							<p>
								<?php esc_html_e( 'The campaign recreates realistic phishing scenarios in a safe environment without exposing your organisation to an actual malicious threat.', 'akaza-adventure' ); ?>
							</p>
						</div>
					</article>
					...
					<article class="sl-infosec-2026-how-it-works__step">
						...
						<div class="sl-infosec-2026-how-it-works__content">
							...
							<p>
								<?php esc_html_e( "See how employees respond to the simulated attack and understand your organisation's phishing resilience through campaign metrics and insights.", 'akaza-adventure' ); ?>
							</p>
						</div>
					</article>
					...
					<article class="sl-infosec-2026-how-it-works__step">
						...
						<div class="sl-infosec-2026-how-it-works__content">
							...
							<ul class="sl-list sl-list--2up sl-infosec-2026-how-it-works__list">
								...
								<li class="sl-list-item">
									<span aria-hidden="true">✓</span>
									<?php esc_html_e( 'Behavioural risk', 'akaza-adventure' ); ?>
								</li>
								<li class="sl-list-item">
									<span aria-hidden="true">✓</span>
