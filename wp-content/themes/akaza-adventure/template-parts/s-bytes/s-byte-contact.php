<?php
/**
 * S-Bytes — Contact / Request a Demo (short form).
 *
...
?>
<section
	class="sl-sbytes-contact"
	id="request-demo"
	aria-labelledby="sl-sbytes-contact-title"
>
	<div class="container">
		<div class="sl-sbytes-contact__grid">

			<div class="sl-sbytes-contact__content">

				<div class="sl-sbytes-contact__heading">
					<span class="sl-home-sub-heading">
						<?php esc_html_e( 'Talk to our team', 'akaza-adventure' ); ?>
					</span>

					<h2 id="sl-sbytes-contact-title">
						<?php esc_html_e( 'See S-Bytes', 'akaza-adventure' ); ?>
						<span><?php esc_html_e( 'in action', 'akaza-adventure' ); ?></span>
					</h2>

					<p class="sl-sbytes-contact__lead">
						<?php
						esc_html_e(
							'Book a short, no-obligation demo and we will walk you through FunFoSec microlearning, campaign scheduling, delivery options, and how S-Bytes fits into your organisation\'s security awareness programme.',
							'akaza-adventure'
						);
						?>
					</p>
				...
				<div class="sl-sbytes-contact__body">
					<p>
						<?php
						esc_html_e(
				...
				<div class="sl-sbytes-contact__details">
					...
					<a class="sl-sbytes-contact__email" href="mailto:info@succeedtech.com">
						<span class="sl-sbytes-contact__email-label">
							<?php esc_html_e( 'Email us', 'akaza-adventure' ); ?>
						</span>
						<span class="sl-sbytes-contact__email-value">
					...
					>
						...
						<span class="sl-sbytes-contact__whatsapp-text">
							<span class="sl-sbytes-contact__whatsapp-label"><?php esc_html_e( 'WhatsApp us', 'akaza-adventure' ); ?></span>
						</span>
					</a>
			...
			<div class="sl-sbytes-contact__form-wrap">
