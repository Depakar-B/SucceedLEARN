    ...
    <div class="container">
		...
		$why_reasons = array(
			...
			array(
				...
				'text'  => __( 'We are confident that once you experience the quality, capabilities and value of SucceedLEARN, you will see how strongly it compares with other solutions in the market.', 'akaza-adventure' ),
			),
		);
		?>
		...
		<div class="sl-cybersecurity-awareness-pricing__why" id="why-this-offer">
			<div class="sl-cybersecurity-awareness-pricing__why-heading">
				...
				<p>
					<?php esc_html_e( 'This is a special introductory offer created for Cybersecurity Awareness Month.', 'akaza-adventure' ); ?>
				</p>
			</div>
			...
			<p class="sl-cybersecurity-awareness-pricing__why-close">
				<?php esc_html_e( 'Your Cybersecurity Awareness Month Programme. Almost Entirely on Us.', 'akaza-adventure' ); ?>
			</p>
		</div>
