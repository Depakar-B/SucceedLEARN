...
>
	<div class="container">
		...
		<div class="sl-cyber-awareness-readiness__heading">
			...
			<p>
				<?php esc_html_e( 'Cybercriminals do not always need to defeat your security systems. Sometimes, they only need one employee to click a link, open an attachment, scan a QR code or respond to a convincing request.', 'akaza-adventure' ); ?>
			</p>
		...
		<div class="sl-cyber-awareness-readiness__grid">
			...
			<article class="sl-cyber-awareness-readiness__card">
				...
				<div class="sl-cyber-awareness-readiness__content">
					...
					<p>
						<?php esc_html_e( 'Build practical cybersecurity knowledge employees can use every day.', 'akaza-adventure' ); ?>
					</p>
				</div>
