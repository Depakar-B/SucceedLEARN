<?php
/**
 * PE/VC Compliance Programs page content wrapper.
 *
...
?>
<main id="main-content" class="sl-training-page sl-pevc-homepage">
	<?php get_template_part( 'template-parts/pevc-compliance-training-programs/hero' ); ?>
	<?php get_template_part( 'template-parts/pevc-compliance-training-programs/pricing' ); ?>
	...
	<?php get_template_part( 'template-parts/pevc-compliance-training-programs/faq' ); ?>
	<?php get_template_part( 'template-parts/pevc-compliance-training-programs/contact' ); ?>
</main>
