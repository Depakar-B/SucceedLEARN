...
/**
 * SucceedLEARN
 * SMCR Training for PE/VC — CPD Certification
 *
...
<section
	...
	class="sl-smcr-cpd"
	aria-labelledby="sl-smcr-cpd-title"
>
	<div class="container">
		<div class="sl-smcr-cpd__main">

			<div class="sl-smcr-cpd__mark">
				<img
					class="sl-smcr-cpd__logo"
			...
			<div class="sl-smcr-cpd__copy">
				<span class="sl-home-sub-heading">
					<?php esc_html_e( 'Certification', 'akaza-adventure' ); ?>
				</span>

				<h2 id="sl-smcr-cpd-title">
					<?php
					echo wp_kses(
				...
				<div class="sl-smcr-cpd__highlights">
					<div class="sl-smcr-cpd__highlight">
				...
				<p class="sl-smcr-cpd__disclaimer">
