...
/**
 * SucceedLEARN
 * SMCR Training for PE/VC — PE/VC Compliance Suite
 *
...
<section
	id="pevc-suite"
	class="sl-smcr-pevc-suite"
	aria-labelledby="sl-smcr-pevc-suite-title"
>
	<div class="container">

		<div class="sl-smcr-pevc-suite__header">
			<div>
				<span class="sl-home-sub-heading">
					<?php esc_html_e( 'PE/VC Compliance Learning Suite', 'akaza-adventure' ); ?>
				</span>

				<h2 id="sl-smcr-pevc-suite-title">
					<?php
					echo wp_kses_post(
						__(
							'SMCR Is Part of a Comprehensive <span>PE/VC Compliance Suite</span>',
							'akaza-adventure'
						)
					);
					?>
				...
				<p>
					<?php
					esc_html_e(
						'Extend SMCR awareness into a broader compliance programme covering cyber security, conduct, financial crime and regulated-firm responsibilities.',
						'akaza-adventure'
					);
					?>
				</p>
		...
		<div class="sl-smcr-pevc-suite__pricing">
			<span class="sl-smcr-pevc-suite__note">
		...
		<div class="sl-smcr-pevc-suite__grid">
			<?php foreach ( $courses as $course ) : ?>
				<article
					class="sl-smcr-pevc-suite__tile<?php echo $course['active'] ? ' is-active' : ''; ?>"
				>
					<div class="sl-smcr-pevc-suite__chrome">
						<span class="sl-smcr-pevc-suite__dash" aria-hidden="true"></span>
						<span class="sl-smcr-pevc-suite__num" aria-hidden="true">
							<?php echo esc_html( $course['num'] ); ?>
						</span>
					</div>
					<h3><?php echo esc_html( $course['title'] ); ?></h3>
					<p><?php echo esc_html( $course['text'] ); ?></p>
					<a class="sl-smcr-pevc-suite__cta" href="<?php echo esc_url( $course['href'] ); ?>">
