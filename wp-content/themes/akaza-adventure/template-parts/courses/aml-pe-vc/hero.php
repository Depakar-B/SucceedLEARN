...
>
	<div class="container">
		...
		<div class="sl-aml-pe-vc-hero__grid">
			...
			<div class="sl-aml-pe-vc-hero__content">
				...
				<div class="sl-hero-actions">
					...
					<a class="sl-hero-btn sl-hero-btn-secondary" href="#individuals">
			...
			<div class="sl-aml-pe-vc-hero__media">
				<div
					class="sl-aml-pe-vc-hero__image-placeholder"
					role="img"
					aria-label="<?php esc_attr_e( 'AML Course Hero Image placeholder', 'akaza-adventure' ); ?>"
				>
					<span><?php esc_html_e( 'AML Course Hero Image', 'akaza-adventure' ); ?></span>
					<small>
						<?php
						esc_html_e(
							'Replace with an approved SucceedLEARN AML visual relevant to investor onboarding, ownership or financial crime risk.',
							'akaza-adventure'
						);
						?>
					</small>
