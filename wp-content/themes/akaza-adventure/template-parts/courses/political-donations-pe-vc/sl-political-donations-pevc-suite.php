...
/**
 * SucceedLEARN
 * Political Donations Training for PE/VC — PE/VC Compliance Suite
 *
...
<section
	id="pevc-suite"
	class="sl-political-donations-pevc-suite"
	aria-labelledby="sl-political-donations-pevc-suite-title"
>
	<div class="container">

		<div class="sl-political-donations-pevc-suite__header">
			<div>
				<span class="sl-home-sub-heading">
					<?php esc_html_e( 'PE/VC Compliance Learning Suite', 'akaza-adventure' ); ?>
				</span>

				<h2 id="sl-political-donations-pevc-suite-title">
					<?php
					echo wp_kses_post(
						__(
							'Political Donations Is Part of a Comprehensive <span>PE/VC Compliance Suite</span>',
							'akaza-adventure'
						)
					);
					?>
				...
				<p>
					<?php
					esc_html_e(
						'Extend political donations awareness into a broader compliance programme covering cyber security, conduct, financial crime and regulated-firm responsibilities.',
						'akaza-adventure'
					);
					?>
				</p>
		...
		<div class="sl-political-donations-pevc-suite__pricing">
		...
		<div class="sl-political-donations-pevc-suite__grid">
			<?php foreach ( $courses as $course ) : ?>
				<article
					class="sl-political-donations-pevc-suite__tile<?php echo $course['active'] ? ' is-active' : ''; ?>"
				>
					<div class="sl-political-donations-pevc-suite__chrome">
						<span class="sl-political-donations-pevc-suite__dash" aria-hidden="true"></span>
						<span class="sl-political-donations-pevc-suite__num" aria-hidden="true">
							<?php echo esc_html( $course['num'] ); ?>
						</span>
					</div>
					<h3><?php echo esc_html( $course['title'] ); ?></h3>
					<p><?php echo esc_html( $course['text'] ); ?></p>
					<a class="sl-political-donations-pevc-suite__cta" href="<?php echo esc_url( $course['href'] ); ?>">
