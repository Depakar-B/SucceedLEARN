...
/**
 * SucceedLEARN
 * Whistleblowing Training for PE/VC — CPD Certification
 *
...
<section
	...
	class="sl-whistleblowing-cpd"
	aria-labelledby="sl-whistleblowing-cpd-title"
>
	<div class="container">
		<div class="sl-whistleblowing-cpd__main">

			<div class="sl-whistleblowing-cpd__mark">
				<img
			...
			<div class="sl-whistleblowing-cpd__copy">
				<span class="sl-home-sub-heading">
					<?php esc_html_e( 'Certification', 'akaza-adventure' ); ?>
				</span>

				<h2 id="sl-whistleblowing-cpd-title">
					<?php
					echo wp_kses(
				...
				<div class="sl-whistleblowing-cpd__highlights">
					<div class="sl-whistleblowing-cpd__highlight">
				...
				<p class="sl-whistleblowing-cpd__disclaimer">
