...
/**
 * SucceedLEARN
 * Gifts and Entertainment Training for PE/VC — CPD Certification
 *
...
<section
	...
	class="sl-gifts-entertainment-cpd"
	aria-labelledby="sl-gifts-entertainment-cpd-title"
>
	<div class="container">
		<div class="sl-gifts-entertainment-cpd__main">

			<div class="sl-gifts-entertainment-cpd__mark">
				<img
					class="sl-gifts-entertainment-cpd__logo"
			...
			<div class="sl-gifts-entertainment-cpd__copy">
				<span class="sl-home-sub-heading">
					<?php esc_html_e( 'Certification', 'akaza-adventure' ); ?>
				</span>

				<h2 id="sl-gifts-entertainment-cpd-title">
					<?php
					echo wp_kses(
				...
				<div class="sl-gifts-entertainment-cpd__highlights">
					<div class="sl-gifts-entertainment-cpd__highlight">
				...
				<p class="sl-gifts-entertainment-cpd__disclaimer">
