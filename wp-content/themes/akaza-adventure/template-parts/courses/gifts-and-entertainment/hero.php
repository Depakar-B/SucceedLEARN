...
>
	<div class="container">
		...
		<div class="sl-gifts-entertainment-hero__grid">
			...
			<!-- Hero Image -->
			<div class="sl-gifts-entertainment-hero__media">

				<div
					class="sl-gifts-entertainment-hero__image-placeholder"
					role="img"
					aria-label="<?php esc_attr_e( 'Gifts and entertainment compliance training image', 'akaza-adventure' ); ?>"
				>
					<span>
						<?php
						esc_html_e(
