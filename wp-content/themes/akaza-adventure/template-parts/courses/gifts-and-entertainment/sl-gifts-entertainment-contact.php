<?php
/**
 * Gifts & Entertainment — Contact / Request a Demo.
 *
	...
	<div class="container">
		<div class="sl-contact__grid">
			...
			<div class="sl-contact__content">
				...
				<h2 id="sl-gifts-entertainment-contact-title">
					<?php esc_html_e( 'Request a PE/VC Gifts and Entertainment Training Demo', 'akaza-adventure' ); ?>
				</h2>
				...
				<div class="sl-contact__copy">
					<p>
						<?php
						esc_html_e(
							'Tell us about your organisation and training requirements to explore how the course may support your PE/VC compliance programme.',
							'akaza-adventure'
						);
						?>
					</p>
