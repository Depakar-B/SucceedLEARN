...
<main id="main-content" class="sl-course-page sl-course-page--gifts-and-entertainment">
	...
	<?php get_template_part( 'template-parts/courses/gifts-and-entertainment/sl-gifts-entertainment-practical-elearning' ); ?>
	<?php get_template_part( 'template-parts/courses/gifts-and-entertainment/sl-gifts-entertainment-faq' ); ?>
	<?php get_template_part( 'template-parts/courses/gifts-and-entertainment/sl-gifts-entertainment-cta' ); ?>
	<?php get_template_part( 'template-parts/courses/gifts-and-entertainment/sl-gifts-entertainment-contact' ); ?>
</main>
