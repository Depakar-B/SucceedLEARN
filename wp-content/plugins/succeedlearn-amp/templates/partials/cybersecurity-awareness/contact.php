	...
	<div class="sl-wrap sl-csa-two-col">
		<div>
			...
			<h2 id="sl-csa-contact-title" class="sl-h2">
				...
				echo wp_kses_post(
					$is_uk
						? __( 'Make Cyber Security Awareness Month <span>measurable.</span>', 'succeedlearn-amp' )
						: __( 'Make Cybersecurity Awareness Month <span>measurable.</span>', 'succeedlearn-amp' )
				);
				?>
			</h2>
			<p class="sl-lead">
				<?php
				esc_html_e(
					'Help employees identify threats, resist manipulation and report suspicious emails. Give your security and learning teams clear evidence of participation, simulation response, reporting activity and improvement.',
					'succeedlearn-amp'
				);
				?>
			</p>
