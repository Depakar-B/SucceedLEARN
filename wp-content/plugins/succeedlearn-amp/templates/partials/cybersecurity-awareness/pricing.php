	...
	<div class="sl-wrap">
		...
		<div class="sl-csa-pricing__why" id="why-this-offer">
			<div class="sl-csa-pricing__why-heading">
				...
				<p>
					...
					if ( succeedlearn_amp_csa_is_uk() ) {
						esc_html_e( 'This is a special introductory offer created for Cyber Security Awareness Month.', 'succeedlearn-amp' );
					} else {
						esc_html_e( 'This is a special introductory offer created for Cybersecurity Awareness Month.', 'succeedlearn-amp' );
					}
					?>
				</p>
			</div>
			...
			<p class="sl-csa-pricing__why-close">
				<?php
				if ( succeedlearn_amp_csa_is_uk() ) {
					esc_html_e( 'Your Cyber Security Awareness Month Programme. Almost Entirely on Us.', 'succeedlearn-amp' );
				} else {
					esc_html_e( 'Your Cybersecurity Awareness Month Programme. Almost Entirely on Us.', 'succeedlearn-amp' );
				}
				?>
			</p>
		</div>
