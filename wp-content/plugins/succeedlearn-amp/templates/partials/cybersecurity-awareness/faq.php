		...
		<h2 id="sl-csa-faq-title" class="sl-h2">
			...
			echo wp_kses_post(
				succeedlearn_amp_csa_is_uk()
					? __( 'Cyber Security Awareness Month <span>FAQs</span>', 'succeedlearn-amp' )
					: __( 'Frequently Asked Questions About <span>Cybersecurity Awareness Month</span>', 'succeedlearn-amp' )
			);
			?>
		</h2>
		<p class="sl-lead">
			...
			if ( succeedlearn_amp_csa_is_uk() ) {
				esc_html_e( 'Need to discuss your environment or campaign scope? Our team can talk you through it.', 'succeedlearn-amp' );
			} else {
				esc_html_e( 'Need to discuss your environment or campaign scope? Our team can walk you through it.', 'succeedlearn-amp' );
			}
			?>
		</p>
