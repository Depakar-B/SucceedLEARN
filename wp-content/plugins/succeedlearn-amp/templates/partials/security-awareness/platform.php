		...
		<div class="sl-sa-platform__grid">
			<div class="sl-sa-platform__content">
				...
				<p class="sl-sa-platform__actions">
					<button type="button" class="sl-content-btn sl-content-btn-primary" <?php echo succeedlearn_amp_scroll_tap_attr( 'contact' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>><?php esc_html_e( 'Know More about the Suite', 'succeedlearn-amp' ); ?></button>
				</p>
			</div>
