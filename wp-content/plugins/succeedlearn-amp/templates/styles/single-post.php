...
.sl-post__cat{display:inline-block;margin:0 0 10px;padding:3px 10px;border-radius:999px;background:rgba(19,93,183,.1);color:#135db7;font-size:12px;font-weight:600;text-transform:uppercase;letter-spacing:.04em}
...
.sl-post__body a{color:#135db7}
.sl-post__body img,.sl-post__body amp-img,.sl-post__body figure{max-width:100%;height:auto}
.sl-post__body blockquote{margin:1.25em 0;padding:0 0 0 14px;border-left:3px solid #135db7;color:#2f4674;font-style:italic}
