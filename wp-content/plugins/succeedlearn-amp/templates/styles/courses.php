...
.sl-courses-cats__link:active{outline:none;border-color:#135db7;border-left-color:#135db7;background:rgba(19,93,183,.08)}
...
.sl-courses__sort-link.is-active{border-color:#135db7;color:#135db7;background:rgba(19,93,183,.08)}
...
.sl-courses-bulk__inner{background:#fff;border-radius:12px;padding:18px 20px;box-shadow:0 8px 24px rgba(22,35,77,.07);border-left:4px solid #135db7}
...
.sl-courses-card__price{font-weight:700;color:#135db7;font-size:16px}
