...
.sl-about-hero{padding:16px;background:var(--sl-page-white)}
.sl-about-hero__grid{display:grid;gap:28px;align-items:center}
.sl-about-hero__eyebrow{display:inline-block;margin:0 0 14px;padding:8px 16px;border:1px solid rgba(19,93,183,.28);border-radius:999px;background:var(--sl-page-white);color:var(--sl-page-primary);font-size:14px;font-weight:600}
