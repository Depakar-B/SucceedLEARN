...
require_once SUCCEEDLEARN_AMP_TEMPLATES_DIR . 'data/about-us.php';
require_once SUCCEEDLEARN_AMP_TEMPLATES_DIR . 'data/clients.php';

$canonical   = succeedlearn_amp_get_about_canonical_url();
$contact_amp = succeedlearn_amp_get_about_contact_amp_url();
$page_title  = succeedlearn_amp_get_about_page_title();
$meta_desc   = succeedlearn_amp_get_about_meta_description();
...
<main id="main-content">
	<?php
	// Section order mirrors theme: template-parts/about-us.php
	succeedlearn_amp_about_partial( 'hero' );
	succeedlearn_amp_about_partial( 'stats' );
	succeedlearn_amp_about_partial( 'clients' );
	?>
</main>
