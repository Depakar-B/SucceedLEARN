...
<head>
	...
	succeedlearn_amp_output_page_styles(
		'pevc',
		array( 'home-page' ),
		array( 'home-sections', 'contact-form', 'pevc' )
	);
	?>
	</style>
...
<main id="main-content">
	<?php
	// Section order mirrors theme: template-parts/private-equity-and-venture-capital-suite.php
	succeedlearn_amp_pevc_partial( 'hero' );
	?>
</main>
