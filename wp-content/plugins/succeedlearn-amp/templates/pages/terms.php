...
require_once SUCCEEDLEARN_AMP_TEMPLATES_DIR . 'data/terms.php';

extract( succeedlearn_amp_get_terms_context(), EXTR_SKIP ); // phpcs:ignore WordPress.PHP.DontExtract.extract_extract
