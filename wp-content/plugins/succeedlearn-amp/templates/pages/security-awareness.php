...
<head>
	...
	succeedlearn_amp_output_page_styles(
		'security_awareness',
		array( 'home-page' ),
		array( 'home-sections', 'contact-form', 'breadcrumbs', 'security-awareness' )
	);
	?>
	</style>
	<?php succeedlearn_amp_output_components( 'security_awareness', array( 'amp-form', 'amp-mustache', 'amp-sidebar', 'amp-carousel', 'amp-bind', 'amp-lightbox', 'amp-accordion' ) ); ?>
</head>
...
<main id="main-content">
	<?php
	// Section order mirrors theme: template-parts/security-awareness-and-phishing.php
