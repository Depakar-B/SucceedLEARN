...
require_once SUCCEEDLEARN_AMP_TEMPLATES_DIR . 'data/sphish-report.php';

extract( succeedlearn_amp_get_sphish_report_context(), EXTR_SKIP ); // phpcs:ignore WordPress.PHP.DontExtract.extract_extract
