...
require_once SUCCEEDLEARN_AMP_TEMPLATES_DIR . 'data/cookie-policy.php';

extract( succeedlearn_amp_get_cookie_policy_context(), EXTR_SKIP ); // phpcs:ignore WordPress.PHP.DontExtract.extract_extract
