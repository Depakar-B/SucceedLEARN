<?php
/**
 * POSH Compliance Essentials Webinar — AMP landing page.
 *
 * Theme template: genesis-sample/posh-compliance-essentials-webinar.php
 *
...
$pwb_banner_alt = 'POSH Compliance Essentials Webinar 2026';
		...
		<div class="pwb-wrap">
			...
			<div class="pwb-hero-content">
				<div class="pwb-hero-head">
					...
					<h3 class="pwb-subtitle"><?php echo esc_html( $pwb_subtitle ); ?></h3>
				</div>

				<div class="pwb-datetime">
					<span class="pwb-datetime-label"><?php esc_html_e( 'Date and Time:', 'elearnposh-amp' ); ?></span>
