...
<main id="main-content">
	...
	<section class="sl-hero">
		...
		<div class="sl-hero__content">
			...
			<div class="sl-hero__actions">
				...
				<a class="sl-btn sl-btn--ghost" href="<?php echo esc_url( $contact_url ); ?>"><?php esc_html_e( 'Watch a Demo', 'succeedlearn-amp' ); ?></a>
			</div>
	...
	<section class="sl-section sl-section--alt">
		<div class="sl-wrap">
			...
			<h2 class="sl-h2"><?php esc_html_e( "Today's challenges run on both sides of the org chart", 'succeedlearn-amp' ); ?></h2>
			<div class="sl-grid-2">
			...
			<div class="sl-reality">
				<div class="sl-reality__grid">
					<div class="sl-reality__media">
						<amp-img
							src="<?php echo esc_url( $uploads . '/2026/07/The-Reality.webp' ); ?>"
							width="409"
							height="273"
							layout="responsive"
					...
					<div class="sl-reality__content">
						...
						<p class="sl-reality__q"><?php esc_html_e( 'Does finishing a course actually change behaviour? Rarely.', 'succeedlearn-amp' ); ?></p>
	...
	<section class="sl-section">
		<div class="sl-wrap">
			...
			<h2 class="sl-h2"><?php esc_html_e( 'Learning Experiences Employees Engage With. Outcomes Employers Can Measure.', 'succeedlearn-amp' ); ?></h2>
	...
	<section class="sl-section sl-section--alt" id="solutions">
		<div class="sl-wrap">
			...
			<h2 class="sl-h2"><?php esc_html_e( 'One platform for security, compliance & workplace learning', 'succeedlearn-amp' ); ?></h2>
	...
	<section class="sl-section">
		<div class="sl-wrap">
			...
			<h2 class="sl-h2"><?php esc_html_e( 'Security Behaviour & Culture Suite (SBCS)', 'succeedlearn-amp' ); ?></h2>
	...
	<section class="sl-section sl-section--alt">
		<div class="sl-wrap">
			...
			<h2 class="sl-h2"><?php esc_html_e( 'Outcomes you achieve', 'succeedlearn-amp' ); ?></h2>
	...
	<section class="sl-section">
		<div class="sl-wrap">
			...
			<h2 class="sl-h2"><?php esc_html_e( 'Getting started is simple', 'succeedlearn-amp' ); ?></h2>
	...
	<section class="sl-section sl-cta-section">
		<div class="sl-wrap">
			<div class="sl-cta-card">
				...
				<h2 class="sl-h2"><?php esc_html_e( 'Ready to build a safer, more compliant workforce?', 'succeedlearn-amp' ); ?></h2>
				...
				<div class="sl-cta-buttons">
					<a class="sl-btn sl-btn--primary" href="<?php echo esc_url( $contact_url ); ?>"><?php esc_html_e( 'Book a Demo', 'succeedlearn-amp' ); ?></a>
	...
	<section class="sl-section" id="contact">
		<div class="sl-wrap sl-contact-layout">
			<div class="sl-contact-intro">
				...
				<amp-img
					src="<?php echo esc_url( $uploads . '/2026/07/Get-Your-Personalized.webp' ); ?>"
					width="720"
					height="640"
					layout="responsive"
					alt="<?php esc_attr_e( 'SucceedLEARN demo', 'succeedlearn-amp' ); ?>"
				></amp-img>
			</div>
