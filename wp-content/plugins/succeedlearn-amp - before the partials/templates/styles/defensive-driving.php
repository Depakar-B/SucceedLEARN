...
?>
.sl-dd-page{--sl-page-navy:#16234e;--sl-page-primary:#1472ba;--sl-page-primary-dark:#283384;--sl-page-primary-soft:rgba(109,195,235,.16);--sl-page-cta:#ea3e24;--sl-page-text:#4A4A4A;--sl-page-muted:#6B7C93;--sl-page-bg:#F5F3EF;--sl-page-white:#fff}
.sl-dd-page .sl-eyebrow{color:var(--sl-page-primary)}
.sl-dd-page .sl-btn--primary{background:var(--sl-page-primary)}
.sl-dd-page .sl-btn--secondary{background:var(--sl-page-navy)}
.sl-dd-hero{position:relative;padding:88px 16px 48px;background:var(--sl-page-navy);color:var(--sl-page-white);overflow:hidden}
...
.sl-dd-faq amp-accordion section{border:1px solid rgba(107,124,147,.18);border-radius:12px;margin-bottom:10px;background:var(--sl-page-white);overflow:hidden}
.sl-dd-faq amp-accordion h3{margin:0;padding:16px 18px;font-size:15px;line-height:1.45;color:var(--sl-page-navy);background:var(--sl-page-white);border:0}
.sl-dd-faq amp-accordion div{padding:0 18px 16px;font-size:14px;line-height:1.65;color:var(--sl-page-text)}
