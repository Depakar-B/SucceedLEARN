...
?>
.sl-hero{position:relative;min-height:78vh;display:flex;align-items:center;color:#fff;padding:88px 16px 48px;background-color:#16234d;background-position:center;background-size:cover;background-repeat:no-repeat}
...
.sl-hero__title{margin:0 0 16px;font-size:32px;line-height:1.2}
...
@media(min-width:700px){.sl-hero__title{font-size:42px}.sl-hero__features{grid-template-columns:1fr 1fr}}
.sl-stat{text-align:center;padding:12px}
.sl-stat__value{font-size:32px;font-weight:800;color:#F04E23;margin:0}
...
.sl-clients__title span{color:#F04E23}
.sl-challenge-card h3,.sl-solution-card h3,.sl-platform-card h3{margin:0 0 10px;font-size:18px;color:#1F2C56}
.sl-card-tag{display:block;color:#F04E23;font-size:15px;font-weight:500;text-transform:none;letter-spacing:normal;margin:0 0 10px}
.sl-outcome-card h3{margin:0 0 12px;font-size:18px;font-weight:700;color:#18A84C}
...
.sl-solution-card .sl-outcome-box h4,.sl-outcome-box h4{margin:0 0 6px;font-size:16px;font-weight:700;color:#F04E23 !important}
...
.sl-reality__media{position:relative;width:100%;max-width:none;margin:0;overflow:hidden}
.sl-reality__media amp-img{display:block;width:100%;border-radius:0}
.sl-reality__content{min-width:0;padding:18px}
@media(min-width:700px){
.sl-reality__grid{display:grid;grid-template-columns:minmax(0,42%) minmax(0,1fr);align-items:stretch}
.sl-reality__media{width:100%;max-width:none;height:100%;min-height:100%;align-self:stretch}
.sl-reality__media amp-img{position:absolute;inset:0;width:100%;height:100%;max-width:none}
.sl-reality__media amp-img img,.sl-reality__media .i-amphtml-fill-content{object-fit:cover}
.sl-reality__media i-amphtml-sizer{display:none !important;padding-top:0 !important}
.sl-reality__content{flex:none;padding:24px}
}
...
.sl-sbcs-tagline{margin:0 0 12px;font-size:18px;font-weight:700;line-height:1.35;color:#16A34A}
...
.sl-metric__value{display:block;font-size:28px;font-weight:700;color:#16A34A;line-height:1.2}
...
.sl-step__label{display:block;color:#F04E23;font-size:16px;font-weight:500;margin:0 0 6px}
...
.sl-cta-contact a:hover{color:#F04E23}
...
.sl-contact-intro amp-img{margin:8px auto 0;max-width:560px;width:100%;border-radius:12px;overflow:hidden}
@media(min-width:700px){.sl-contact-intro amp-img{display:none}}
