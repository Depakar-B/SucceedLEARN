...
.sl-blog__sort-link.is-active{border-color:#ea3f23;color:#ea3f23;background:rgba(234,63,35,.08)}
...
.sl-blog-pill.is-active{border-color:#ea3f23;color:#ea3f23;background:rgba(234,63,35,.08);font-weight:600}
...
.sl-blog-card__cat{align-self:flex-start;display:inline-block;padding:3px 10px;border-radius:999px;background:rgba(234,63,35,.1);color:#ea3f23;font-size:12px;font-weight:600;line-height:1.4;text-transform:uppercase;letter-spacing:.04em;margin:0}
...
.sl-blog-card__more{color:#ea3f23;font-weight:700;text-decoration:none;font-size:14px}
