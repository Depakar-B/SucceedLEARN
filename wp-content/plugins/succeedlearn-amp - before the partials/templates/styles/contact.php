...
?>
.sl-contact-page{--sl-page-navy:#16234e;--sl-page-primary:#ea3e24;--sl-page-primary-dark:#d4331c;--sl-page-primary-soft:#fdece8;--sl-page-blue:#1472ba;--sl-page-text:#4A4A4A;--sl-page-muted:#6B7C93;--sl-page-bg:#F5F3EF;--sl-page-white:#fff}
.sl-contact-page .sl-eyebrow{color:var(--sl-page-primary)}
.sl-contact-page .sl-btn--primary{background:var(--sl-page-primary)}
...
.sl-contact-hero__eyebrow{display:inline-block;margin:0 0 14px;padding:8px 16px;border:1px solid rgba(234,62,36,.28);border-radius:999px;background:var(--sl-page-white);color:var(--sl-page-primary);font-size:14px;font-weight:600}
