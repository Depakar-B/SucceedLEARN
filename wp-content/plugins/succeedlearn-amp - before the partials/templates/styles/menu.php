...
$sl_amp_scroll_offset = function_exists( 'succeedlearn_amp_get_scroll_offset' )
	...
	: 120;
?>
:root{--sl-navy:#16234d;--sl-navy-deep:#0f1a3a;--sl-accent:#F04E23;--sl-cream:#f4f3ee;--sl-text:#1a1a1a;--sl-muted:#4a5568;--sl-side-pad:20px;--sl-amp-scroll-offset:<?php echo (int) $sl_amp_scroll_offset; ?>px}
html,body{background:#fff;color:var(--sl-text)}
html{scroll-padding-top:var(--sl-amp-scroll-offset)}
body{padding-top:108px;font-family:"Space Grotesk",Arial,sans-serif;margin:0;line-height:1.5}
...
.sl-amp-sidebar__link--child:active{color:var(--sl-accent);background:rgba(240,78,35,.06)}

/* ── Sidebar footer CTA ── */
.sl-amp-sidebar__footer{padding:18px var(--sl-side-pad) 28px;border-top:1px solid #eef0f5;background:#fff;margin-top:8px}
.sl-amp-btn{display:block;width:100%;box-sizing:border-box;text-align:center;background:var(--sl-accent);color:#fff!important;text-decoration:none;padding:14px 18px;border-radius:10px;font-weight:700;font-size:15px;line-height:1.2}
