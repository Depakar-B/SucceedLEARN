...
?>
.sl-home{overflow-x:hidden;--sl-page-primary:#1472ba;--sl-heading-accent:#1472ba}
.sl-section{padding:24px 16px}
.sl-section--alt{background:#F7F7F7}
.sl-wrap{max-width:1100px;margin:0 auto}
.sl-eyebrow{display:inline-block;color:var(--sl-heading-accent,#135db7);font-size:15px;font-weight:500;letter-spacing:normal;text-transform:none;margin:0 0 10px}
.sl-h2{margin:0 0 14px;font-size:28px;line-height:1.25;color:#1F2C56}
.sl-h2 span{color:var(--sl-page-primary,#1472ba)}
.sl-lead{margin:0 0 24px;font-size:16px;line-height:1.6;color:#4a5568}
.sl-btn{display:inline-block;padding:12px 20px;border-radius:8px;font-weight:700;text-decoration:none;font-size:15px;font-family:inherit;cursor:pointer;border:1px solid transparent;box-sizing:border-box;text-align:center}
button.sl-btn{-webkit-appearance:none;appearance:none}
.sl-btn--secondary{background:#1F2C56;color:#fff;margin-left:8px}
.sl-btn.sl-btn--ghost,.sl-btn--ghost{background:transparent;color:#fff;border:1px solid rgba(255,255,255,.55);margin-left:8px}
