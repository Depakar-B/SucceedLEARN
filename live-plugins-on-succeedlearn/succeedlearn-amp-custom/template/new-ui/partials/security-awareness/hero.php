...
$brochure_url = function_exists( 'succeedlearn_amp_get_sa_brochure_url' )
	? succeedlearn_amp_get_sa_brochure_url()
	: add_query_arg( 'download', 'Security-Behaviour-Culture-Suite-Brochure.pdf', home_url( '/' ) );
?>
		...
		<div class="sl-sa-hero__grid">
			<div class="sl-sa-hero__content">
				...
				<div class="sl-sa-hero__actions">
					...
					><?php esc_html_e( 'Explore the Suite', 'succeedlearn-amp' ); ?></a>
					<a
						href="<?php echo esc_url( $brochure_url ); ?>"
						class="sl-btn sl-btn--secondary"
						download="Security-Behaviour-Culture-Suite-Brochure.pdf"
					><?php esc_html_e( 'Download Brochure', 'succeedlearn-amp' ); ?></a>
				</div>
			</div>
