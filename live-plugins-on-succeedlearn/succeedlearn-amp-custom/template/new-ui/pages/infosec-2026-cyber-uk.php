<?php
/**
 * SucceedLEARN AMP — Infosec Cybersecurity Awareness Month 2026 (UK).
 * Copied from US; update UK copy later.
 *
...
<head>
	...
	succeedlearn_amp_output_page_styles(
		'infosec_2026_cyber_uk',
		array( 'home-page' ),
		array( 'home-sections', 'contact-form', 'landing-header', 'infosec-2026-cyber' )
	);
	?>
	</style>
	<?php succeedlearn_amp_output_components( 'infosec_2026_cyber_uk', array( 'amp-form', 'amp-mustache', 'amp-accordion', 'amp-bind', 'amp-lightbox' ) ); ?>
</head>
<body class="sl-home sl-infosec-2026-cyber-page sl-infosec-2026-cyber-page--uk">
<?php
