	...
	return array(
		...
		'rows'  => array(
			array(
				...
				'text'   => __( 'Equip employees to identify common cyber risks, verify unusual requests, protect business information and make safer decisions in everyday work.', 'succeedlearn-amp' ),
				'items'  => array(
			...
			array(
				...
				'text'   => __( 'Test how employees respond to realistic but controlled phishing scenarios. Each simulation is approved in advance, safely delivered and measured without collecting genuine passwords.', 'succeedlearn-amp' ),
				'items'  => array(
...
function succeedlearn_amp_csa_faq_items() {
	return array(
		array(
			...
			'answer'   => __( 'No, not under this special offer. The offer covers the Cybersecurity Awareness Month campaign for October 2026. If you extend the service beyond October, you will receive a 50% discount on the first-year extension.', 'succeedlearn-amp' ),
		),
		array(
		...
		array(
			...
			'answer'   => __( 'There is no separate per-user charge within the selected employee band. Choose the band that matches the number of active participants in your business.', 'succeedlearn-amp' ),
		),
		array(
		...
		array(
			...
			'answer'   => __( 'This special introductory offer is available until October 15, 2026. Succeed Technologies reserves the right to modify or withdraw the offer at any time during the promotional period.', 'succeedlearn-amp' ),
		),
		array(
			'question' => __( 'What if my organization has more than 10,000 users?', 'succeedlearn-amp' ),
			'answer'   => __( 'For organizations with more than 10,000 users, request a demo or email us at <a href="mailto:connect@succeedtech.com">connect@succeedtech.com</a>. We’ll be happy to understand your requirements and provide a customized offer.', 'succeedlearn-amp' ),
		),
		array(
			'question' => __( 'Can the Security Awareness eLearning content be customized?', 'succeedlearn-amp' ),
			'answer'   => __( 'Yes. The eLearning content can be customized to reflect your organization’s policies, branding, or specific training requirements. Customization will involve an additional cost and may require additional implementation time. The scope, pricing, and delivery timeline will be agreed upon before work begins.', 'succeedlearn-amp' ),
		),
		array(
