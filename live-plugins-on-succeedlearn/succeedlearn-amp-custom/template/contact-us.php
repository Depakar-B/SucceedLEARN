...
<head>
  <meta charset="utf-8">
  <title>Contact Us | Corporate Compliance Solutions | SucceedLearn</title>
  <link rel="canonical" href="https://succeedlearn.com/contact-us/">
...
<?php include(plugin_dir_path(__FILE__) . 'amp-cookie-consent.php'); ?>	
	...
	<section class="contact-us-top-section">
	<h2 class="heading"><span class="black">Contact</span><span class="blue"> Us</span></h2>
		<h3 class="contact-us-subheading">Your perspective is invaluable to us. We eagerly await your input.</h3>
	</section>
	
	<section class="contact-us-form-section">
		<div class="contact-us-support-card">
			<span class="contact-us-subheading">
				We're here to help!
			</span>
			<h2 class="contact-us-form-text-heading">
			...
			<p class="contact-us-email-label">Email Us:</p>
			<p class="contact-us-email-value">
				<a href="mailto:sales@succeedtech.com" class="email-link">sales@succeedtech.com</a>
			</p>
			<div class="contact-us-support-image-wrap">
				<amp-img
					src="https://succeedlearn.com/wp-content/uploads/2026/01/Got-questions.png"
					width="840"
					height="580"
					layout="responsive"
